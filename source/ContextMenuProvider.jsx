...
class ContextMenuProvider extends Component {
    ...
    onContextMenu = (event) => {
        // The menu should have already been built up via the context handler while the event was bubbling up.
        // If the menu was empty then it's possible the user right-clicked on something that wasn't context menu
        // connected, therefore we need to close the menu.
